...
public class Slot : MonoBehaviour
{
    ...
    public void Click()
    {
        ...
        {
            slotImage.sprite = Resources.Load<Sprite>("Inventary/select");
            Inventory.selectedSlot = this;
        }
        else if (Inventory.selectedSlot == this)
        {
            slotImage.sprite = Resources.Load<Sprite>("Inventary/slot");
            Inventory.selectedSlot = null;
        }
        else
        {
            Inventory.selectedSlot.slotImage.sprite = Resources.Load<Sprite>("Inventary/slot");
